...
WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Full Name_firstName'), 'Juara')

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Full Name_lastName'), 'Coding')

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Email_oxd-input oxd-input--active'), 'JuaraCoding@gmail.com')

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/div_Browse'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/button_Save'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/h6_Application Stage'))
